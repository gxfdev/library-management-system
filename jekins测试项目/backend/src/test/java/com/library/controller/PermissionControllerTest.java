...
class PermissionControllerTest {
    ...
    @Test
    @DisplayName("读者自助借阅未借过的图书应成功")
    void readerSelfBorrowNewBookShouldSucceed() throws Exception {
    ...
    @Test
    @DisplayName("读者重复借阅同一图书应返回400")
    void readerDuplicateBorrowShouldReturn400() throws Exception {
        BorrowRequest request = new BorrowRequest();
    ...
    @Test
    @DisplayName("馆员新增图书缺少必填字段应返回400")
